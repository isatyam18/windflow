...
# load model runner
checkpoint_file = str(BASE_DIR / 'model_weights' / 'windflow.raft.pth.tar')
...
# load data
file1 = str(BASE_DIR / 'data' / 'OR_ABI-L1b-RadC-M6C10_G16_s20222751101170_e20222751103554_c20222751103590.nc')
file2 = str(BASE_DIR / 'data' / 'OR_ABI-L1b-RadC-M6C10_G16_s20222751106170_e20222751108554_c20222751108596.nc')
